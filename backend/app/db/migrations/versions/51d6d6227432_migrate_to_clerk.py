...
down_revision: Union[str, None] = '895ddd914ffb'
...
def upgrade() -> None:
    ...
    op.alter_column('analysis_jobs', 'user_id',
               existing_type=sa.TEXT(),
               type_=sa.String(length=50),
               existing_nullable=False)
    op.drop_constraint(op.f('analysis_jobs_user_id_fkey'), 'analysis_jobs', type_='foreignkey')
    ...
    op.alter_column('commit_events', 'user_id',
               existing_type=sa.TEXT(),
               type_=sa.String(length=50),
               existing_nullable=False)
    op.drop_constraint(op.f('commit_events_user_id_fkey'), 'commit_events', type_='foreignkey')
    op.create_foreign_key(None, 'commit_events', 'users', ['user_id'], ['id'])
    op.alter_column('pr_drafts', 'user_id',
               existing_type=sa.TEXT(),
               type_=sa.String(length=50),
               existing_nullable=False)
    ...
    op.alter_column('requirements', 'user_id',
               existing_type=sa.TEXT(),
               type_=sa.String(length=50),
               existing_nullable=False)
    op.drop_constraint(op.f('requirements_user_id_fkey'), 'requirements', type_='foreignkey')
    op.create_foreign_key(None, 'requirements', 'users', ['user_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    op.create_foreign_key(op.f('requirements_user_id_fkey'), 'requirements', 'user', ['user_id'], ['id'], ondelete='CASCADE')
    op.alter_column('requirements', 'user_id',
               existing_type=sa.String(length=50),
               type_=sa.TEXT(),
               existing_nullable=False)
    op.drop_constraint(None, 'repositories', type_='foreignkey')
    op.create_foreign_key(op.f('repositories_user_id_fkey'), 'repositories', 'user', ['user_id'], ['id'])
    op.alter_column('repositories', 'user_id',
               existing_type=sa.String(length=50),
               type_=sa.TEXT(),
               existing_nullable=False)
    op.drop_constraint(None, 'pr_drafts', type_='foreignkey')
    op.create_foreign_key(op.f('pr_drafts_user_id_fkey'), 'pr_drafts', 'user', ['user_id'], ['id'])
    op.alter_column('pr_drafts', 'user_id',
               existing_type=sa.String(length=50),
               type_=sa.TEXT(),
               existing_nullable=False)
    op.drop_constraint(None, 'commit_events', type_='foreignkey')
    op.create_foreign_key(op.f('commit_events_user_id_fkey'), 'commit_events', 'user', ['user_id'], ['id'])
    op.alter_column('commit_events', 'user_id',
               existing_type=sa.String(length=50),
               type_=sa.TEXT(),
               existing_nullable=False)
    op.drop_constraint(None, 'audit_logs', type_='foreignkey')
    op.create_foreign_key(op.f('audit_logs_user_id_fkey'), 'audit_logs', 'user', ['user_id'], ['id'])
    op.alter_column('audit_logs', 'user_id',
               existing_type=sa.String(length=50),
               type_=sa.TEXT(),
               existing_nullable=False)
    op.drop_constraint(None, 'analysis_jobs', type_='foreignkey')
    op.create_foreign_key(op.f('analysis_jobs_user_id_fkey'), 'analysis_jobs', 'user', ['user_id'], ['id'])
    op.alter_column('analysis_jobs', 'user_id',
               existing_type=sa.String(length=50),
               type_=sa.TEXT(),
               existing_nullable=False)
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('account_user_id_fkey'), ondelete='CASCADE'),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('session_user_id_fkey'), ondelete='CASCADE'),
