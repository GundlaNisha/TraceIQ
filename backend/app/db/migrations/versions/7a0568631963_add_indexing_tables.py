...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_code_dependencies_repository_id"),
        "code_dependencies",
        ["repository_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_code_chunks_file_id"), "code_chunks", ["file_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_code_symbols_file_id"), "code_symbols", ["file_id"], unique=False
    )
    op.create_index(
        op.f("ix_code_symbols_symbol_name"),
        "code_symbols",
        ["symbol_name"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_code_embeddings_chunk_id"),
        "code_embeddings",
        ["chunk_id"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_repository_files_snapshot_id"), table_name="repository_files"
    )
    op.drop_index(
    ...
    op.drop_index(
        op.f("ix_code_dependencies_repository_id"), table_name="code_dependencies"
    )
